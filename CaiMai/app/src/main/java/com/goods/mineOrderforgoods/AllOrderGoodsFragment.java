...
//	};
	...
	private OrderGoodsListAdapter.OnListViewClickLinstener onListViewClickLinstener = new OrderGoodsListAdapter.OnListViewClickLinstener() {

		@Override
		public void itemClick(int position, OrderGoodsListAdapter.ViewHolder holder, int state) {
			// TODO Auto-generated method stub
			switch (state) {
			case 0:
