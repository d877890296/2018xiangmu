...
public class OrderforgoodsActivity extends BaseActivity {
    ...
    private AllOrderGoodsFragment allOrderGoodsFragment, dfkOrderGoodsFragment, dfhOrderGoodsFragment, pszOrderGoodsFragment, dpjOrderGoodsFragment, endOrderGoodsFragment;
...
//    private DfhOrderGoodsFragment dfhOrderGoodsFragment;
    ...
    public void dataInit() {
        ...
        //int  1待支付 2待发货 3配送中 4待评价 5已评价 6已取消
        // 所有商品
        allOrderGoodsFragment = new AllOrderGoodsFragment();
        allOrderGoodsFragment.setStatus(0);
        // 待支付
        dfkOrderGoodsFragment = new AllOrderGoodsFragment();
        dfkOrderGoodsFragment.setStatus(1);
        // 待发货
        dfhOrderGoodsFragment = new AllOrderGoodsFragment();
        dfhOrderGoodsFragment.setStatus(2);
        // 配送中
        pszOrderGoodsFragment = new AllOrderGoodsFragment();
...
//        allOrderGoodsFragment5 = new AllOrderGoodsFragment();
        ...
        if (baseType == 1) {//全部
            ...
            orderGoods_pager.setCurrentItem(6);
        }
