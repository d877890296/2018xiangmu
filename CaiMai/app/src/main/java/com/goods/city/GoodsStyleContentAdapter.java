...
public class GoodsStyleContentAdapter extends LzBaseAdapter {
...
public List<GoodsStyleModel> data;
    ...
    public GoodsStyleContentAdapter(Context context) {
        super(context);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            convertView=inflater.inflate(R.layout.goods_stylecontent_item,null);
