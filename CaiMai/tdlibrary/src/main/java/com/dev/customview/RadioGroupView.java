        	...
        	((RadioButton) child).setOnTouchListener(new OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					if(mOnCheckedChangeListener != null){
						mOnCheckedChangeListener.onCheckedChanged(RadioGroupView.this, child.getId());
					}
					return true;
				}
			});
        		...
        		if (view instanceof RadioButton) {
                	...
                	((RadioButton) button).setOnTouchListener(new OnTouchListener() {
        				...
        				public boolean onTouch(View v, MotionEvent event) {
        					...
        					if(mOnCheckedChangeListener != null){
        						mOnCheckedChangeListener.onCheckedChanged(RadioGroupView.this, button.getId());
        					}
        					return true;
        				}
        			});
...
//      
//        event.setClassName(RadioGroupView.class.getName());
//    }
...
//        info.setClassName(RadioGroupView.class.getName());
//    }
