...
public class FieldUtils {
	...
	public static String getColumnByField(Field field){
		NetJsonFiled property = field.getAnnotation(NetJsonFiled.class);
		if(property != null && property.name().trim().length() != 0){
			return property.name();
		}
		return field.getName();
	}
	public static Boolean isJsonField(Field field){
		NetJsonFiled property = field.getAnnotation(NetJsonFiled.class);
		if(property == null ){
			return false;
		}
	...
	public static  Class<?> getArrayClassType(Field field) {
		NetJsonFiled property = field.getAnnotation(NetJsonFiled.class);
		if(property==null)
		{
			return null;
		...
		Class<?>  clazz = null;
		try {
			clazz=Class.forName(property.objClassName());
	...
	public static boolean isArrayListType(Field field){
		Class<?> clazz = field.getType();
