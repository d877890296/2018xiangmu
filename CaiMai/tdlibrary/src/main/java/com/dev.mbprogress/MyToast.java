...
public class MyToast {
	...
	private static TextView textView, textView_state_type,
			textView_currentTime, textView_totaltTime;
	...
	public static void showMyToast(Context context, String content,
		...
		if (myToast == null) {
			...
			textView_state_type = (TextView) view
					.findViewById(R.id.textView_state_type);
			liner_toast_type1 = (LinearLayout) view
					.findViewById(R.id.liner_toast_type1);
			liner_toast_type2 = (LinearLayout) view
					.findViewById(R.id.liner_toast_type2);
			// 设置到Toast中
	...
	public static void showMyToast2(Context context, String content,
			String content2, int gravityStyle, int leftOrRight) {
		if (myToast2 == null) {
			myToast2 = new Toast(context);
			// 加载一个View
			view2 = LayoutInflater.from(context).inflate(R.layout.my_toast2,
					null);
			textView_currentTime = (TextView) view2
					.findViewById(R.id.textView_currentTime);
			textView_totaltTime = (TextView) view2
					.findViewById(R.id.textView_totaltTime);
	...
	public static void setContent2(int gravityStyle, String content,
			String content2, int leftOrRight) {
