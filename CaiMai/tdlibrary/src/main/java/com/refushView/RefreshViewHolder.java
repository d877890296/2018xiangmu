...
/**
 * 作者:lyy 邮件:1083573260@qq.com 创建时间:16/5/21 12:56
...
public abstract class RefreshViewHolder {
	 ...
	 */
	// public void setLoadMoreBackgroundColorRes(@ColorRes int
	// loadMoreBackgroundColorRes) {
	 ...
	 */
	// public void setLoadMoreBackgroundDrawableRes(@DrawableRes int
	 ...
	 */
	// public void setRefreshViewBackgroundColorRes(@ColorRes int
	// refreshViewBackgroundColorRes) {
	 ...
	 */
	// public void setRefreshViewBackgroundDrawableRes(@DrawableRes int
	// refreshViewBackgroundDrawableRes) {
	...
	public View getLoadMoreFooterView() {
		...
		if (mLoadMoreFooterView == null) {
			mLoadMoreFooterView = View.inflate(mContext, R.layout.footer_bga_dodo, null);
